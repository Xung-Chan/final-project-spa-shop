...
public class CustomerController {
	...
	public ResponseEntity<ApiResponse<PaginationResponse>> getTotalPage() {
		return new ResponseEntity<>(new ApiResponse<>(customerService.getTotalPage()), HttpStatus.OK);
	}
	@GetMapping("/all/{page}")
	public ResponseEntity<ApiResponse<List<CustomerResponse>>> getAllByPage(@PathVariable int page) {
		return new ResponseEntity<>(new ApiResponse<>(customerService.getAllByPage(page)), HttpStatus.OK);
	}
...
//	@DeleteMapping("")
//	public ResponseEntity<ApiResponse<CustomerResponse>> deleteById(@RequestParam long id) {
//		return new ResponseEntity<>(new ApiResponse<>(customerService.delete(id)), HttpStatus.OK);
//	}
